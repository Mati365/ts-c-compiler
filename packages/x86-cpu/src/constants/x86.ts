...
export const X86_FLAGS_MASKS = R.mapObjIndexed(offset => 1 << offset, X86_FLAGS_OFFSETS);
...
export const CP437_UNICODE_FONT_MAPPING = [
  ...
  0x0079, 0x007a, 0x007b, 0x007c, 0x007d, 0x007e, 0x007f, 0x00c7, 0x00fc, 0x00e9, 0x00e2,
