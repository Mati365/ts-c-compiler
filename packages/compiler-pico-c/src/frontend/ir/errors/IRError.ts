import { CompilerError, fixme } from '@ts-cc/core';
...
export enum IRErrorCode {
  ...
  GLOBAL_INITIALIZER_MUST_HAVE_ONLY_CONSTANT_EXPRESSIONS = 'GLOBAL_INITIALIZER_MUST_HAVE_ONLY_CONSTANT_EXPRESSIONS',
}
...
export const C_IR_ERROR_TRANSLATIONS: Record<IRErrorCode, string> = {
  ...
  [IRErrorCode.GLOBAL_INITIALIZER_MUST_HAVE_ONLY_CONSTANT_EXPRESSIONS]:
    'Global initializer must have only constant expressions!',
};
