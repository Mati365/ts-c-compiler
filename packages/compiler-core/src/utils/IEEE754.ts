...
export function toIEEE754(v: number, ebits: number, fbits: number): number[] {
  ...
  let s: number | boolean, e: number, f: number;
...
export function fromIEEE754Extended(b: number[]): number {
  return fromIEEE754(b, 15, 63);
}

export function toIEEE754Extended(v: number): number[] {
  return toIEEE754(v, 15, 63);
}

export function fromIEEE754Double(b: number[]): number {
  return fromIEEE754(b, 11, 52);
}

export function toIEEE754Double(v: number): number[] {
  return toIEEE754(v, 11, 52);
}

export function fromIEEE754Single(b: number[]): number {
  return fromIEEE754(b, 8, 23);
}

export function toIEEE754Single(v: number): number[] {
